...
<header id="header-fixed">
    ...
    <main>
        <div class="container my-5">
            ...
            if (isset($_SESSION['message'])) {
                // 登録成功メッセージの表示
                echo '<div class="alert alert-success text-center" role="alert">' . htmlspecialchars($_SESSION['message'], ENT_QUOTES, 'UTF-8') . '</div>';
            ...
            <form action="insert_incident.php" method="post" class="input-form" onsubmit="return validateForm()">
                <!-- CSRFトークンを含める -->
                ...
                <div class="mb-3">
                    <label for="targetName" class="form-label">対象者名 <span class="text-danger">*</span></label>
                    <input type="text" class="form-control" id="targetName" name="targetName" placeholder="対象者の名前を入力" required>
                </div>
                <div class="mb-3">
                    <label for="incidentDetails" class="form-label">詳細 <span class="text-danger">*</span></label>
                    <textarea class="form-control" id="incidentDetails" name="incidentDetails" rows="5" placeholder="ヒヤリハットの詳細を入力してください" required></textarea>
                </div>
    ...
    <!-- <footer>
        <p class="text-center">文教大学 情報学部 情報システム学科 プロジェクト演習BC</p>
        <p class="text-center">&copy; 2024, Team F, All rights reserved.</p>
    </footer> -->
